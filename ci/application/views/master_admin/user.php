                ...
                <form id="form-edit-user-datatables" class="flex -mx-5" data-parsley-validate data-parsley-focus="first">
                    <div class="w-1/3 overflow-hidden my-5 px-5">
                        ...
                        <div class="block mx-3 form-group">
                            ...
                            <input id="username" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Username" name="username" data-parsley-required>
                        </div>
                    </div>
