<div class="py-10">
    <div class="container mx-auto">
        ...
        <div class="py-20">
            <p class="text-center text-2xl"> <?php echo ucfirst($first_name); ?> <?php echo ucfirst($last_name); ?></p>
            <?php if(!empty($age)): ?>
                <span class="block text-center"> years <?php echo $age; ?> old</span>
            <?php endif; ?>
            <div class="flex overflow-hidden">
                <p class="text-center text-xl"><?php echo $email; ?></p>
            </div>
            <div class="flex overflow-hidden">
                <p class="text-center text-xl"><?php echo $address; ?></p>
            </div>
        </div>
    </div>
</div>
